  ...
  return (
    <div className="min-w-0">
      ...
      <div className="mt-1.5 h-1.5 w-full overflow-hidden rounded-full bg-muted">
        <div className="h-full rounded-full bg-ok transition-[width] duration-500" style={{ width: `${filled}%`, backgroundColor: filled >= 90 ? "var(--destructive)" : filled >= 75 ? "var(--warn)" : undefined }} />
      </div>
